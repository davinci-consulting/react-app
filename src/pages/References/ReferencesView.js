        ...
        <Styled.References id="references">
            <Styled.Container>
                ...
                <Styled.LeftArrow ref={navigationPrevRef}>
                    <ChevronLeftArrow width="43px" height="43px" fill="none" stroke="#444444" strokeWidth="1.5px" />
                </Styled.LeftArrow>
                <Styled.RightArrow ref={navigationNextRef}>
                    <ChevronRightArrow width="43px" height="43px" fill="none" stroke="#444444" strokeWidth="2px" />
                </Styled.RightArrow>
            </Styled.Container>
        </Styled.References>
    )
